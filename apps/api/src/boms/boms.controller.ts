...
import { ArrayMinSize, IsArray, IsEnum, IsIn, IsOptional, IsString, MaxLength, ValidateNested } from 'class-validator';
...
class BomItemOptionsQueryDto {
  @IsIn(['output', 'component']) role: 'output' | 'component';
...
export class BomsController {
  ...
  @Permissions('bom.view') @Get('item-options') itemOptions(@Query() q: BomItemOptionsQueryDto) { return this.service.itemOptions(q); }
